...
ki = LineClient("ksamr800@gmail.com","ssaa1122")
ki.log("Auth Token : " + str(ki.authToken))
channel1 = LineChannel(ki,ki.server.CHANNEL_ID['LINE_TIMELINE'])
ki.log("Channel Access Token : " + str(channel1.channelAccessToken))


kk = LineClient("abos3ed100@gmail.com","ssaa1122")
kk.log("Auth Token : " + str(kk.authToken))
channel2 = LineChannel(kk)
kk.log("Channel Access Token : " + str(channel2.channelAccessToken))


kc = LineClient("ksamr50@gmail.com","ssaa1122")
                ...
                try:
                    if cl.getGroup(op.param1).preventedJoinByTicket == False:
                        if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                            ...
                            kj.sendMessage(op.param1,"opening qr")
...
#KICKALL
                        elif "!eric" in msg.text:
                          if msg._from in admin:
                           if msg.toType == 2:
                              print("ok")
                              _name = msg.text.replace("!eric","")
...
">>>Ⓑⓨⓔ_Ⓑⓨⓔ ⒼⒸ Ⓛⓐⓚⓝⓐⓣ>><\nⒹⓝⓓⓐⓜ Ⓒⓐⓡⓘ Ⓚⓜⓘ\n<<<<<<<<<>>\nhttp://line.me/ti/p/~reza.p.i.p\nhttp://line.me/ti/p/ryansakra_m1")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                cl.sendMessage(msg.to, "she is a girl?")
                                ki.sendMessage(msg.to, "[☯️ hello darling]2")
                                kk.sendMessage(msg.to, "[☯️ hello darling]3")
                                kc.sendMessage(msg.to, "[☯️ hello darling]4")
                                kb.sendMessage(msg.to, "[☯️ hello darling]5")
                                kd.sendMessage(msg.to, "[☯️ hello darling]6")
                                ke.sendMessage(msg.to, "[☯️ hello darling]7")
                                kf.sendMessage(msg.to, "[☯️ hello darling]8")
                                kj.sendMessage(msg.to, "[☯️ hello darling]9")
                                sw.sendMessage(msg.to, "[☯️ hello darling]10")
                                cl.sendMessage(msg.to, "")
...
#===========BOT UPDATE============#
                        elif msg.text in ["Cipok","Tagall","Desah","Emuach","شاكر","تاق","Siang","Sore","Malam","Nah","All"]:
                               if wait["selfbot"] == True:
                                if msg._from in admin:
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:                              
                               sendMention1(msg.to, sender, "speed","")
                               start = time.time() / 3 
                               time.sleep(0.002)  
...
#===========Hiburan============#
                        ...
                        elif cmd == "rsp" or cmd == "cannibal":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                cl.sendMessage(msg.to, "hello darling  ")
                                ki.sendMessage(msg.to, "hello darling  ")
                                kk.sendMessage(msg.to, "hello darling  ")
                                kc.sendMessage(msg.to, "hello darling  ")
                                kb.sendMessage(msg.to, "hello darling  ")
                                kd.sendMessage(msg.to, "hello darling  ")
                                ke.sendMessage(msg.to, "hello darling  ")
                                kf.sendMessage(msg.to, "hello darling  ")
                                kj.sendMessage(msg.to, "hello darling  ")
                                sw.sendMessage(msg.to, "hello darling  ")
                                #cl.sendMessage(msg.to, "All hello darling  Hdir\nAmankan Room\nDemi Amanat Bos Q")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                try:
                                    ...
                                    cl.sendMessage(msg.to,"Grup "+str(ginfo.name)+"Staying)
                                except:
                                    pass           
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                              if wait["blacklist"] == {}:
                                    cl.sendMessage(msg.to,"noting in penjahat")
                                    ki.sendMessage(msg.to,"noting in penjahat")
                                    kk.sendMessage(msg.to,"noting in penjahat")
                                    kc.sendMessage(msg.to,"noting in penjahat")
                                    kb.sendMessage(msg.to,"noting in penjahat")
                                    kd.sendMessage(msg.to,"noting in blacklist")
                                    ke.sendMessage(msg.to,"noting in blacklist")
                                    kf.sendMessage(msg.to,"noting in blacklist")
                                    kj.sendMessage(msg.to,"noting in blacklist")
                                    sw.sendMessage(msg.to,"noting in blacklist")
                              else:
                                    ma = ""
                                    for i in wait["blacklist"]:
                                        ma = cl.getContact(i)
                                        cl.sendMessage(msg.to, None, contentMetinta={'mid': i}, contentType=13)

                        elif cmd == "cban" or text.lower() == 'clearban1':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                              wait["blacklist"] = {}
                              ragets = cl.getContacts(wait["blacklist"])
                              mc = "「%i」User Blacklist" % len(ragets)
                              cl.sendMessage(msg.to,"done cleared " +mc)
                              ki.sendMessage(msg.to,"done cleared " +mc)
                              kk.sendMessage(msg.to,"done cleared " +mc)
                              kc.sendMessage(msg.to,"done cleared " +mc)
                              kb.sendMessage(msg.to,"done cleared " +mc)
                              kd.sendMessage(msg.to,"done cleared " +mc)
                              ke.sendMessage(msg.to,"done cleared " +mc)
                              kf.sendMessage(msg.to,"done cleared " +mc)
                              kj.sendMessage(msg.to,"done cleared " +mc)
                              sw.sendMessage(msg.to,"done cleared " +mc)
                              ...
                              if spl == 'on':
                                  ...
                                  cl.sendMessage(msg.to, "「Diaktifkan」\n" + msgs)
                                    ...
                                    if msg.to in protectantijs:
                                         ...
                                         msgs = "Anti JS Sudah noting Aktif"
...
#=========== [ Add Image ] ============#
                          ...
                          if msg._from in admin:
                            ...
                            if name in images:
                                ...
                                cl.sendText(msg.to, "Foto itu noting in dalam list") 
...
#=========== [ Add Video ] ============#                               
                          ...
                          if msg._from in admin:
                            ...
                            if name in videos:
                                ...
                                cl.sendText(msg.to, "Video itu noting in dalam list") 
...
#=========== [ Add Video ] ============#                               
                          ...
                          if msg._from in admin:
                            ...
                            if name in audios:
                                ...
                                cl.sendText(msg.to, "Mp3 itu noting in dalam list") 
...
#=========== [ Add Sticker ] ============#                                            
                          ...
                          if msg._from in admin:
                            ...
                            if name in stickers:
                                ...
                                cl.sendText(msg.to, "Sticker itu noting in dalam list") 
...
"╱╱╱╱╱╱╱╱╱╰━━┻━━╯\n"
">>>Ⓑⓨⓔ_Ⓑⓨⓔ ⒼⒸ Ⓛⓐⓚⓝⓐⓣ>><\nⒹⓝⓓⓐⓜ Ⓒⓐⓡⓘ Ⓚⓜⓘ\n<<<<<<<<<>>\nhttp://line.me/ti/p/~reza.p.i.p\nhttp://line.me/ti/p/ryansakra_m1")
                               cl.sendMessage(msg.to, None, contentMetinta={"STKID":"15996978","STKPKGID":"1416471","STKVER":"1"}, contentType=7)

                        elif cmd == "botdk-bot" or cmd == "botdkbot":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               start = time.time()
                               cl.sendMessage(msg.to, "[☯️ hello darling].")
                               elapsed_time = time.time() - start
                               cl.sendMessage(msg.to, "╚☆Ⓢⓘⓐⓟ☆╗\n╚Ⓚⓞⓜⓐⓝⓓⓝ╮╗".format(str(elapsed_time)))
                              ...
                              if spl == 'on':
                                  ...
                                  cl.sendMessage(msg.to, "「 Status Welcome 」\n" + msgs)
                                    ...
                                    if msg.to in welcome:
                                         ...
                                         msgs = "Welcome Msg sudah noting aktif"
                                    cl.sendMessage(msg.to, "「 Status Welcome 」\n" + msgs)
                              ...
                              if spl == 'on':
                                  ...
                                  cl.sendMessage(msg.to, "「 Status Protect Url 」\n" + msgs)
                                    ...
                                    if msg.to in protectqr:
                                         ...
                                         msgs = "Protect url sudah noting aktif"
                                    cl.sendMessage(msg.to, "「 Status Protect Url 」\n" + msgs)
                              ...
                              if spl == 'on':
                                  ...
                                  cl.sendMessage(msg.to, "「 Status Protect kick 」\n" + msgs)
                                    ...
                                    if msg.to in protectkick:
                                         ...
                                         msgs = "Protect kick sudah noting aktif"
                                    cl.sendMessage(msg.to, "「 Status Protect kick 」\n" + msgs)
                              ...
                              if spl == 'on':
                                  ...
                                  cl.sendMessage(msg.to, "「 Status Protect Join 」\n" + msgs)
                                    ...
                                    if msg.to in protectjoin:
                                         ...
                                         msgs = "Protect join sudah noting aktif"
                                    cl.sendMessage(msg.to, "「 Status Protect Join 」\n" + msgs)
                              ...
                              if spl == 'on':
                                  ...
                                  cl.sendMessage(msg.to, "「 Status Protect Cancel 」\n" + msgs)
                                    ...
                                    if msg.to in protectcancel:
                                         ...
                                         msgs = "Protect cancel sudah noting aktif"
                                    cl.sendMessage(msg.to, "「 Status Protect Cancel 」\n" + msgs)
                              ...
                              if spl == 'on':
                                  ...
                                  cl.sendMessage(msg.to, "「 Status Protect Invite 」\n" + msgs)
                                    ...
                                    if msg.to in protectinvite:
                                         ...
                                         msgs = "Protect invite sudah noting aktif"
                                    cl.sendMessage(msg.to, "「 Status Protect Invite 」\n" + msgs)
