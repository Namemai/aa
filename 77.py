...
cl = LineClient(authToken="EPdJZ71uQqw344hxZbd1.xcn7DMPQDX0eNo15HQPomq.t3H41gPswGAgzD4q39nJtnxNlcU7LfFRuRQ2yXamqJg=")
cl.log("Auth Token : " + str(cl.authToken))
channel = LineChannel(cl)
cl.log("Channel Access Token : " + str(channel.channelAccessToken))

ki = LineClient(authToken="EPyHMTl6Ej16v2R21qP7.dCSPEDVuUkG9mCGBu1O89W.brOYYWDgBhowLgk0yhTouNaNZ7NELDjU4HVmTD3R32s=")
ki.log("Auth Token : " + str(ki.authToken))
ki.log("Channel Access Token : " + str(channel.channelAccessToken))


kk = LineClient(authToken="EPZrQvAnkm2Nvj42Nna7.EqX+qYc0HAKY9iLCiV8nrW.v9JCDyQYGFRKM6wB03afV7h5SH9IgeZx4ww5q6/XGzU=")
kk.log("Auth Token : " + str(kk.authToken))
kk.log("Channel Access Token : " + str(channel.channelAccessToken))


kc = LineClient(authToken="EPy1PYS374H9XfeMktW8.FA78w+8oB3jVdOR0HsEega.VMAooZjf621QYDpdgNZcHS+zyXWk3rW9KnP5DyChBpM=")
kc.log("Auth Token : " + str(kc.authToken))
kc.log("Channel Access Token : " + str(channel.channelAccessToken))

kb = LineClient(authToken="EPCsmERLkwZkHPCdVmAe.YPH95gtJWE4611vdwLW/3G.ZkshEmV+3BXUE7lWAyqa6f/Nr16V/qIyepCV0rnxNhA=")
kb.log("Auth Token : " + str(kb.authToken))
kb.log("Channel Access Token : " + str(channel.channelAccessToken))


kd = LineClient(authToken="EPHaRDsYXNRM2tAfxTs3.4hjM+ZEAlxJfxrFEqjHEKW.w6S/zXtmlECMpyP5hdyJG3p2lKL1EaSuwPxntnk2mTU=")
kd.log("Auth Token : " + str(kd.authToken))
kd.log("Channel Access Token : " + str(channel.channelAccessToken))


ke = LineClient(authToken="EPG9LFunr7jM2BNJ0cc9.FK9Drslldc0AgZXYr0p3Iq.dgdU9koDB//3dyxeunJDyKjhYDW+Lj8GxqTauhXAeN0=")
ke.log("Auth Token : " + str(ke.authToken))
ke.log("Channel Access Token : " + str(channel.channelAccessToken))


kf = LineClient(authToken="EPYtyuKOhONOxronl6i4.ZVFhZfrE2ocNFU3oCnPHna.fWB/6JMFsfFAspAabVICFf3hbez4KPMOyQ4KgFiyyEA=")
kf.log("Auth Token : " + str(kf.authToken))
kf.log("Channel Access Token : " + str(channel.channelAccessToken))


sw = LineClient(authToken="EPh2NTCESthK4FsWUhR9.X9oLI5rtp3hOwbCRAgNq6q.o/98GTPa+Yv1OVihVvlyzS7mSWalLWFlzNXFc4BHdPU=")
    ...
    try:
                ...
                try:
                    if cl.getGroup(op.param1).preventedJoinByTicket == False:
                        if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                            ...
                            sw.sendMessage(op.param1,"อย่าเปิดลิ้งเล่นนะค่ะ..")
        ...
        if op.type == 5:
              if wait["autoAdd"] == True:
                  ...
                  sendMention(op.param1, op.param1, "Haii ", ", รอผมมาปลอดบล็อค")
                                        ...
                                        try:
                                            ...
                                            try:
                                                ...
                                                try:
                                                    ...
                                                    try:
                                                        cl.kickoutFromGroup(op.param1,[op.param2])
                                                        cl.inviteIntoGroup(op.param1,[Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid])
                                                        ki.acceptGroupInvitation(op.param1)
                                                        kk.acceptGroupInvitation(op.param1)
                                                        kc.acceptGroupInvitation(op.param1)
                                                        kb.acceptGroupInvitation(op.param1)
                                        ...
                                        try:
                                            ...
                                            try:
                                                ...
                                                try:
                                                    ...
                                                    try:
                                                        ki.kickoutFromGroup(op.param1,[op.param2])
                                                        ki.inviteIntoGroup(op.param1,[mid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid])
                                                        cl.acceptGroupInvitation(op.param1)
                                                        kk.acceptGroupInvitation(op.param1)
                                                        kc.acceptGroupInvitation(op.param1)
                                                        kb.acceptGroupInvitation(op.param1)
                                    ...
                                    try:
                                        ...
                                        try:
                                            ...
                                            try:
                                                ...
                                                try:
                                                    kk.inviteIntoGroup(op.param1,[Amid,mid,Cmid,Dmid,Emid,Fmid,Gmid])
                                                    cl.acceptGroupInvitation(op.param1)
                                                    ki.acceptGroupInvitation(op.param1)
                                                    kc.acceptGroupInvitation(op.param1)
                                                    kb.acceptGroupInvitation(op.param1)
                                            ...
                                            try:
                                                ...
                                                try:
                                                    ...
                                                    try:
                                                        ...
                                                        try:
                                                            kc.kickoutFromGroup(op.param1,[op.param2])
                                                            kc.inviteIntoGroup(op.param1,[Amid,Bmid,mid,Dmid,Emid,Fmid,mid])
                                                            cl.acceptGroupInvitation(op.param1)
                                                            ki.acceptGroupInvitation(op.param1) 
                                                            kk.acceptGroupInvitation(op.param1) 
                                                            kf.acceptGroupInvitation(op.param1) 
                                            ...
                                            try:
                                                ...
                                                try:
                                                    ...
                                                    try:
                                                        ...
                                                        try:
                                                            kb.kickoutFromGroup(op.param1,[op.param2])
                                                            kb.inviteIntoGroup(op.param1,[Amid,Bmid,Cmid,mid,Emid,Fmid,mid])
                                                            cl.acceptGroupInvitation(op.param1)
                                                            ki.acceptGroupInvitation(op.param1) 
                                                            kk.acceptGroupInvitation(op.param1) 
                                                            kf.acceptGroupInvitation(op.param1) 
                                            ...
                                            try:
                                                ...
                                                try:
                                                    ...
                                                    try:
                                                        ...
                                                        try:
                                                            kd.kickoutFromGroup(op.param1,[op.param2])
                                                            kd.inviteIntoGroup(op.param1,[Amid,Bmid,Cmid,Dmid,mid,Fmid,mid])
                                                            cl.acceptGroupInvitation(op.param1)
                                                            ki.acceptGroupInvitation(op.param1) 
                                                            kk.acceptGroupInvitation(op.param1) 
                                                            kc.acceptGroupInvitation(op.param1) 
                                            ...
                                            try:
                                                ...
                                                try:
                                                    ...
                                                    try:
                                                        ...
                                                        try:
                                                            ke.kickoutFromGroup(op.param1,[op.param2])
                                                            ke.inviteIntoGroup(op.param1,[Amid,Bmid,Cmid,Dmid,Emid,mid,mid])
                                                            cl.acceptGroupInvitation(op.param1)
                                                            ki.acceptGroupInvitation(op.param1) 
                                                            kk.acceptGroupInvitation(op.param1) 
                                                            kc.acceptGroupInvitation(op.param1) 
                                            ...
                                            try:
                                                ...
                                                try:
                                                    ...
                                                    try:
                                                        ...
                                                        try:
                                                            kf.kickoutFromGroup(op.param1,[op.param2])
                                                            kf.inviteIntoGroup(op.param1,[Amid,Bmid,Cmid,Dmid,Emid,Fmid,mid])
                                                            cl.acceptGroupInvitation(op.param1)
                                                            ki.acceptGroupInvitation(op.param1) 
                                                            kk.acceptGroupInvitation(op.param1) 
                                                            kc.acceptGroupInvitation(op.param1) 
                 ...
                 if text is None:
                     return
                        ...
                        if cmd == "เปิดบอท":
                            if msg._from in admin:
                                wait["selfbot"] = True
                                cl.sendText(msg.to, "เปิดการทำงานระบบบอทเรียบร้อย")
                                
                        elif cmd == "ปิดบอท":
                            if msg._from in admin:
                                wait["selfbot"] = False
                                cl.sendText(msg.to, "ปิดการทำงานระบบบอทเรียบร้อย")
                          ...
                          if wait["selfbot"] == True:
                           ...
                           if msg._from in admin:
                            ...
                            if msg._from in admin:
                                ...
                                try:kd.inviteIntoGroup(to, [Emid]);has = "OK"
                                except:has = "NOT"
                                try:kd.kickoutFromGroup(to, [Emid]);has1 = "OK"
                                except:has1 = "NOT"
                                if has == "OK":sil = "ok ยังไม่บัค"
                                else:sil = "บัคแล้ว"
                                if has1 == "OK":sil1 = "ok ยังไม่บัค"
                                else:sil1 = "บัคแล้ว"
                                kd.sendMessage(to, "ค่าสถานะ\nเตะ : {} \nเชิญ : {}".format(sil1,sil))
                                try:ke.inviteIntoGroup(to, [Fmid]);has = "OK"
                                except:has = "NOT"
                                try:ke.kickoutFromGroup(to, [Fmid]);has1 = "OK"
                                except:has1 = "NOT"
                                if has == "OK":sil = "ok ยังไม่บัค"
                                else:sil = "บัคแล้ว"
                                if has1 == "OK":sil1 = "ok ยังไม่บัค"
                                ...
                                try:kf.inviteIntoGroup(to, [Gmid]);has = "OK"
                                except:has = "NOT"
                                try:kf.kickoutFromGroup(to, [Gmid]);has1 = "OK"
                                except:has1 = "NOT"
                                if has == "OK":sil = "ok ยังไม่บัค"
                                else:sil = "บัคแล้ว"
                                if has1 == "OK":sil1 = "ok ยังไม่บัค"
...
#===========COMMAND BLACKLIST============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                              ...
                              cl.sendMessage(msg.to,"ล้างดำแล้ว..ok " +mc)
                              ki.sendMessage(msg.to,"ล้างดำแล้ว..ok" +mc)
                              kk.sendMessage(msg.to,"ล้างดแล้วำ..ok" +mc)
                              kc.sendMessage(msg.to,"ล้างดำแล้ว..ok" +mc)
                              kb.sendMessage(msg.to,"ล้างดำแล้ว..ok" +mc)
                              kd.sendMessage(msg.to,"ล้างดำแล้ว..ok" +mc)
                              ke.sendMessage(msg.to,"ล้างดำแล้ว..ok" +mc)
                              kf.sendMessage(msg.to,"ล้างดำแล้ว..ok" +mc)
#===========BOT UPDATE============#
                            ...
                            if msg._from in admin:
                              if settings["autoJoinTicket"] == True:
                                 ...
                                 for ticket_id in n_links:
                                     group = cl.findGroupByTicket(ticket_id)
                                     cl.acceptGroupInvitationByTicket(group.id,ticket_id)
                                     cl.sendMessage(msg.to, "ดีงับ : %s" % str(group.name))
